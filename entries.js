...
const entries = [
  {
    ...
    description:
      "The first submission to the One HTML Page Challenge. It is a simple ASCII man starting the dance from Napoleon Dynamite.",
...

  {
    ...
    description:
      "Simulation of an ant colony creating a never ending underground colony. The 'Q' represents a queen that can giver birth to ants 'A'. Food sources are represented by the numbers 9 - 1. (Currently only works in desktop Chrome)",
    author: "Christopher Powroznik (Metroxe)",
    github: "Metroxe",
  ...
  },
  {
    ...
    description:
      "Drag the top right corner on the building. Price increases as building gets bigger.",
...

  {
    ...
    filename: "ApjKalam.html",
    description:
      "A tribute page to Apj Abdul Kalam using simple frontend language",
    author: "Sanket Mane",
    github: "Sanketmane2323",
  },

  {
    ...
    description:
      "Simple memory testing game that I created during a flight while my laptop battery slowly approached 0%. Each level gets faster & adds 1 more color in randomized order to remember!",
    author: "Spencer Gray",
  ...
  },
  {
    ...
    description:
      "This is a simple counter for 2023 new year with gradient color background!!",
    author: "Israa Gargar",
    github: "Esogargar",
  },
  {
    ...
    description:
      "In chess, Fool's Mate, also known as the Two-Move Checkmate, is the checkmate in the fewest possible number of moves from the start of the game. This play is created by animating grid rows and columns.",
  ...
  },
  {
    ...
    description:
      " A Pure CSS Still Life. No images, No SVG, just CSS, absolutely pointless!",
    author: "Ben Evans",
    github: "ivorjetski",
  },
  {
    ...
    description:
      "Calculates the amount of hours worked based on the start and end time of the work shifts and break times if there is any.",
  ...
  },
  {
    ...
    description:
      "simple car racing game, collecting energys on road, speeds up as many energy consumed, slow down if miss energy on road. driving is unlimited",
  ...
  },
  {
    ...
    description:
      "Moon and stars showing a twinkiling effect. The background also turns to night view upon hovering over the moon, stars or the body.",
  ...
  },
  {
    ...
    description:
      "Shows you the time with a lovely background generated from the current time.",
    author: "mechamech",
    github: "mechamech",
  },
  {
    ...
    description:
      "A little quiz about the named colors. You try and guess what the color displayed is called.",
  ...
  },
  {
    ...
    description:
      "Recreation of the terminal window from a scene in the movie Wargames.",
  ...
  },
  {
    ...
    description:
      "Nothing to see here. This was an HTML challenge, so I tried to do just HTML.",
    author: "Shawn Oden",
    github: "shawnoden",
  },
  {
  ...
  },
  {
    ...
    description:
      "Wave your magic wand!  A simple demo using mouse motion and button.",
    author: "Jacob Ewing",
    github: "jacobEwing",
  },
  {
  ...
  },
  {
    ...
    description:
      "CSS only loaders is still the buzz now so I imported one of my tests.",
    author: "Markus Mafz",
  ...
  },
  {
    ...
    description:
      "My first submission to the One HTML Page Challenge.It is a simple snake game using html, css and javascript.",
  ...
  },
  {
    ...
    description:
      "Applied an <feTurbulence> to an image of my hometown Ladner British Columbia, in order to create a cool water effect.",
    author: "Christopher Powroznik (Metroxe)",
    github: "Metroxe",
  },
  {
    ...
    description:
      "Nearly full implementation of the original Minesweeper game (no high scores list).  Left click to hit a square and test for mines, right click to plant a flag.",
    author: "Terry McKay",
    github: "terrymckay",
  },
  {
  ...
  },
  {
    ...
    description:
      "Its a hover website, when u hover on a box it will react diiferently and background will keep on changing its color.",
    author: "rahil",
    github: "Rahilcode",
  },
  {
  ...
  },
  {
    ...
    description:
      "Baby is home alone and hungry. Take baby 👶 to the milk 🍼. It is my baby step towards HTML/JS/CSS 😉",
  ...
  },
  {
    ...
    filename: "clock.html",
    description:
      "This is an analog-cum-digital clock with both dark and light modes!!",
    author: "Sumandeep Kaur",
    github: "Sumandeep-Kaur",
  },
  {
    ...
    description:
      "Well, this is an application form for asking me on a date kind of thing",
    author: "Lailah Grant",
    github: "lailahgrant",
  },
  {
  ...
  },
  {
    ...
    description:
      "Prints a fortune cookie message on the screen, randomly generated by an algorithm.",
  ...
  },
  {
    ...
    description:
      "Pink vs Unknowns is a simulation where two sides have opposite contradictory missions.",
    author: "Aliaksandr B.",
    github: "ByAliaksandr",
  ...
  },
  {
    ...
    description:
      "Ping Pong is a classical arcade game which you can play with two people. You can also set the computer as an auto player, moreover set two auto players and watch them while they play against each other.",
  ...
  },
  {
    ...
    description:
      "A simple game leveraging the Audio API. Listen to the audio and try to figure out at which house a party is going on!",
  ...
  },
  {
    ...
    description:
      "You just got your new job in Amsterdam and moved in. After you picked up your new laptop from the Frontmen offices you need to return to your new home. Little did you know about these crazy bikes...",
  ...
  },
  {
    ...
    description:
      "You have a lot of debt and nothing but your body to pay for it",
    author: "Justin Chao",
    github: "jutsK",
  },
  {
    ...
    description:
      "A smooth Css transition to slowly load the contents of the web page",
  ...
  },
  {
    ...
    description:
      "A task list application with local storage and filter tasks functionality",
  ...
  },
  {
    ...
    description:
      "Draws a hilbert curve, a curve to map a two dimensional space in one dimension",
    author: "Ahmad Raza",
    github: "razaahmad333",
  },
  {
  ...
  },
  {
    ...
    description:
      "A random colour generator which shows you different colours after every click",
    author: "Rajiv Sahal",
    github: "Ryukemeister",
  },
  {
  ...
  },
  {
    ...
    description:
      "A Basic Sudoku Game which solves sudoku puzzle if places filled correctly.",
    author: "Udhav Sharma",
  ...
  },
  {
    ...
    description:
      "Renders cards of random colors that can be copied by clicking on the card. Reload button to generate new cards.",
  ...
  },
  {
    ...
    description:
      'This entry was coded completely by OpenAI using the prompt "code me a game in one html file".',
    author: "OpenAI",
    github: "openai",
  },
  {
    ...
    description:
      "You basically click the square as many times as you can in 30 seconds",
  ...
  },
  {
    ...
    description:
      "Simple mandelbrot fractal viewer in WebGL. Zoom in and move around with the mouse.",
    author: "Parkin Pham",
    github: "P4GAN",
  },
  {
